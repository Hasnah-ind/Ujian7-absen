        ...
        return (
            ...
            style={{flex: 1, width: '100%'}}
              ...
              <DatePicker
               ...
               date = {this.state.fromdate} onDateChange={fromdate =>this.setState({fromdate})}/>
               <Text style={{fontSize : 15, marginBottom:10, marginTop:10,}}>Sampai Tanggal</Text>
              <DatePicker
                style={styles.datePickerStyle}
               placeholder="select date"
               date = {this.state.untildate} onDateChange={untildate =>this.setState({untildate})}/>
             ...
             <TouchableOpacity style={styles.buttonGallery} onPress={this.pickImage} >
                     <Text style={styles.buttonText}>Gallery</Text>
              </TouchableOpacity> 
              <TouchableOpacity style={styles.buttonCamera} onPress={this.captureCamera} >
